...
/*
*	Overloading malloc allocator class when utilizing Jason Evan's malloc jemalloc
*	allocator.cpp
*	Created on: Oct 6, 2015
*	Author: Christian Mie{\ss}en, Institute for Physical Metallurgy and Metal Physics, RWTH Aachen University
*/
